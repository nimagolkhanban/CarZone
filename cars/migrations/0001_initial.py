# Generated by Django 5.0.3 on 2024-03-16 22:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('TEHRAN', 'Tehran'), ('SHIRAZ', 'Shiraz'), ('HAMDAN', 'Hamedan'), ('ESFHAN', 'Esfehan'), ('KERMAN', 'Kerman'), ('ALBORZ', 'Alborz'), ('BANABS', 'Bandarabas'), ('RASHTG', 'Rashtgilan'), ('KORDTN', 'Kordestan'), ('GORGAN', 'Gorgan'), ('ZANJAN', 'Zanjan'), ('TABRIZ', 'Tabriz')], max_length=6)),
